...
COMMENT ON COLUMN public.form_answers.field_id IS 'Links to the form field this answer is for.';
COMMENT ON COLUMN public.form_answers.value IS 'Stores the answer value (can be different types: string, number, array, etc.).';
